...
<section>
    ...
    <p><h4 style="bg-success" class="text-primary"> Listado de Registados  Proyecto Ingenio</h4></p>
    </div>
    </section>
	...
	<div class=" col-md-12">
	 ...
	 ?>
	  <tr>
            ...
            <td><?php echo strtolower ($listar->t_proyecto);?></td>
            <td><?php echo strtolower ($listar->d_proyecto);?></td>
